...
public class AdoptersTests
{
    ...
    public void TestCreateAdopter_ShouldCreateNewIndividualAdopter()
    {
        ...
        var controller = new AdopterController((IAdopterService)mockRepository);
        ...
        Microsoft.VisualStudio.TestTools.UnitTesting.CollectionAssert.DoesNotContain(newAdopter2.Email, "john3doe@gmail.com");
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(newAdopter1.Email != newAdopter2.Email, "Email already exists");
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreNotEqual(newAdopter1.PhoneNumber, newAdopter2.PhoneNumber, "Phone number already exists");
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreNotEqual(newAdopter1.Address, newAdopter2.Address, "Address already exists");
    }
}